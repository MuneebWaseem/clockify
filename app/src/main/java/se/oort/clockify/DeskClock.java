...
import se.oort.clockify.stopwatch.StopwatchFragment;
import se.oort.clockify.stopwatch.StopwatchService;
import se.oort.clockify.stopwatch.Stopwatches;
import se.oort.clockify.timer.TimerFragment;
import se.oort.clockify.timer.TimerObj;
import se.oort.clockify.timer.Timers;
import se.oort.clockify.worldclock.CitiesActivity;
